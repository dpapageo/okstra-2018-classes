...
@XmlType(name = "CylindricalCSPropertyType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
    "cylindricalCS"
})
public class CylindricalCSPropertyType {

    @XmlElementRef(name = "CylindricalCS", namespace = "http://www.opengis.net/gml/3.2", type = CoordinateSystemsCylindricalCS.class, required = false)
    protected CoordinateSystemsCylindricalCS cylindricalCS;
     ...
     *     
     */
    public CoordinateSystemsCylindricalCS getCylindricalCS() {
     ...
     *     
     */
    public void setCylindricalCS(CoordinateSystemsCylindricalCS value) {
