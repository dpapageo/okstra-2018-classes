...
/**
 * <p>Java class for Kennwert_zur_LaermberechnungType complex type.
 * 
 ...
 *         &lt;element name="Stundengruppe" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType"/&gt;
 *         &lt;element name="Kraftfahrzeuge_pro_h" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Anzahl"/&gt;
 *         &lt;element name="Bezugsjahr" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Jahr"/&gt;
 *         &lt;element name="hat_Anteil_Kennwert" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "Kennwert_zur_LaermberechnungType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class KennwertZurLaermberechnungType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Stundengruppe", required = true)
    protected KeyValuePropertyType stundengruppe;
    @XmlElement(name = "Kraftfahrzeuge_pro_h", required = true)
    protected BigInteger kraftfahrzeugeProH;
    @XmlElement(name = "Bezugsjahr", required = true)
    protected BigInteger bezugsjahr;
    @XmlElement(name = "hat_Anteil_Kennwert")
    protected List<ObjectRefType> hatAnteilKennwert;
    ...
    /**
     * Gets the value of the stundengruppe property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public KeyValuePropertyType getStundengruppe() {
        return stundengruppe;
    }

    /**
     * Sets the value of the stundengruppe property.
     * 
     * @param value
     *     allowed object is
     *     {@link KeyValuePropertyType }
     *     
     */
    public void setStundengruppe(KeyValuePropertyType value) {
        this.stundengruppe = value;
    }

    /**
     * Gets the value of the kraftfahrzeugeProH property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getKraftfahrzeugeProH() {
        return kraftfahrzeugeProH;
    }

    /**
     * Sets the value of the kraftfahrzeugeProH property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setKraftfahrzeugeProH(BigInteger value) {
        this.kraftfahrzeugeProH = value;
    }
    ...
    /**
     * Gets the value of the hatAnteilKennwert property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatAnteilKennwert property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatAnteilKennwert().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatAnteilKennwert() {
        if (hatAnteilKennwert == null) {
            hatAnteilKennwert = new ArrayList<ObjectRefType>();
        }
        return this.hatAnteilKennwert;
    }
