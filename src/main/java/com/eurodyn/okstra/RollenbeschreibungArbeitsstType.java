...
/**
 * <p>Java class for Rollenbeschreibung_ArbeitsstType complex type.
 * 
...
@XmlType(name = "Rollenbeschreibung_ArbeitsstType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    "bezeichnung",
    "beschreibung",
    "zuRolleArbeitsstelle"
})
public class RollenbeschreibungArbeitsstType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "zu_Rolle_Arbeitsstelle")
    protected List<ObjectRefType> zuRolleArbeitsstelle;
    ...
    /**
     * Gets the value of the zuRolleArbeitsstelle property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the zuRolleArbeitsstelle property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getZuRolleArbeitsstelle().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getZuRolleArbeitsstelle() {
        if (zuRolleArbeitsstelle == null) {
            zuRolleArbeitsstelle = new ArrayList<ObjectRefType>();
        }
        return this.zuRolleArbeitsstelle;
    }
