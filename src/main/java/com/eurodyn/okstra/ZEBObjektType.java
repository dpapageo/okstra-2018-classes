...
/**
 * <p>Java class for ZEB_ObjektType complex type.
 * 
 ...
 *         &lt;element name="ZEB_Objekt" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="Objektnummer" type="{http://www.w3.org/2001/XMLSchema}integer" minOccurs="0"/&gt;
 *         &lt;element name="hat_Verkehrsrichtung" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="von_ZEB_Projekt" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "ZEB_ObjektType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "zu_Querschnittstreifen")
    protected List<ObjectRefType> zuQuerschnittstreifen;
    @XmlElement(name = "zu_Verkehrsflaeche")
    protected List<ObjectRefType> zuVerkehrsflaeche;
    @XmlElement(name = "ZEB_Objekt")
    protected String zebObjekt;
    @XmlElement(name = "Objektnummer")
    protected BigInteger objektnummer;
    @XmlElement(name = "hat_Verkehrsrichtung")
    protected KeyValuePropertyType hatVerkehrsrichtung;
    @XmlElement(name = "gilt_fuer_Fahrstreifen")
    protected List<ObjectRefType> giltFuerFahrstreifen;
    @XmlElement(name = "von_ZEB_Projekt", required = true)
    ...
    /**
     * Gets the value of the zuQuerschnittstreifen property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the zuQuerschnittstreifen property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getZuQuerschnittstreifen().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getZuQuerschnittstreifen() {
        if (zuQuerschnittstreifen == null) {
            zuQuerschnittstreifen = new ArrayList<ObjectRefType>();
        }
        return this.zuQuerschnittstreifen;
    }

    /**
     * Gets the value of the zuVerkehrsflaeche property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the zuVerkehrsflaeche property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getZuVerkehrsflaeche().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getZuVerkehrsflaeche() {
        if (zuVerkehrsflaeche == null) {
            zuVerkehrsflaeche = new ArrayList<ObjectRefType>();
        }
        return this.zuVerkehrsflaeche;
    }

    /**
     * Gets the value of the zebObjekt property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getZEBObjekt() {
        return zebObjekt;
    }

    /**
     * Sets the value of the zebObjekt property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setZEBObjekt(String value) {
        this.zebObjekt = value;
    }
     ...
     *     
     */
    public BigInteger getObjektnummer() {
        return objektnummer;
    }
     ...
     *     
     */
    public void setObjektnummer(BigInteger value) {
        this.objektnummer = value;
    }

    /**
     * Gets the value of the hatVerkehrsrichtung property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public KeyValuePropertyType getHatVerkehrsrichtung() {
        return hatVerkehrsrichtung;
    }

    /**
     * Sets the value of the hatVerkehrsrichtung property.
     * 
     * @param value
     *     allowed object is
     *     {@link KeyValuePropertyType }
     *     
     */
    public void setHatVerkehrsrichtung(KeyValuePropertyType value) {
        this.hatVerkehrsrichtung = value;
    }
