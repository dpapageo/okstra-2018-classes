...
/**
 * <p>Java class for RW_WirkungsbereichType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RW_WirkungsbereichType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="beginnt_bei_Strassenpunkt" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="endet_bei_Strassenpunkt" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="von_Richtungswechselbetrieb" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "RW_WirkungsbereichType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    "vonRichtungswechselbetrieb"
})
public class RWWirkungsbereichType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "beginnt_bei_Strassenpunkt")
    protected List<ObjectRefType> beginntBeiStrassenpunkt;
    @XmlElement(name = "endet_bei_Strassenpunkt")
    protected List<ObjectRefType> endetBeiStrassenpunkt;
    @XmlElement(name = "von_Richtungswechselbetrieb")
    protected List<ObjectRefType> vonRichtungswechselbetrieb;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the beginntBeiStrassenpunkt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBeginntBeiStrassenpunkt().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getBeginntBeiStrassenpunkt() {
        if (beginntBeiStrassenpunkt == null) {
            beginntBeiStrassenpunkt = new ArrayList<ObjectRefType>();
        }
        return this.beginntBeiStrassenpunkt;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the endetBeiStrassenpunkt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEndetBeiStrassenpunkt().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getEndetBeiStrassenpunkt() {
        if (endetBeiStrassenpunkt == null) {
            endetBeiStrassenpunkt = new ArrayList<ObjectRefType>();
        }
        return this.endetBeiStrassenpunkt;
    }

    /**
     * Gets the value of the vonRichtungswechselbetrieb property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the vonRichtungswechselbetrieb property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVonRichtungswechselbetrieb().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getVonRichtungswechselbetrieb() {
        if (vonRichtungswechselbetrieb == null) {
            vonRichtungswechselbetrieb = new ArrayList<ObjectRefType>();
        }
        return this.vonRichtungswechselbetrieb;
    }
