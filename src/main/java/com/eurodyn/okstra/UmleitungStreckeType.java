...
/**
 * <p>Java class for Umleitung_StreckeType complex type.
 * 
 ...
 *         &lt;element name="zu_Umleitung" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Umleitung_StreckeType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class UmleitungStreckeType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "zu_Umleitung")
    protected List<ObjectRefType> zuUmleitung;
    ...
    /**
     * Gets the value of the zuUmleitung property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the zuUmleitung property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getZuUmleitung().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getZuUmleitung() {
        if (zuUmleitung == null) {
            zuUmleitung = new ArrayList<ObjectRefType>();
        }
        return this.zuUmleitung;
    }
