...
/**
 * <p>Java class for Anteil_am_DTVType complex type.
 * 
 ...
 *         &lt;element name="Fahrzeuggruppe" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType"/&gt;
...
@XmlType(name = "Anteil_am_DTVType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Fahrzeuggruppe", required = true)
    protected KeyValuePropertyType fahrzeuggruppe;
    @XmlElement(name = "zu_MSV")
    protected List<ObjectRefType> zuMSV;
    ...
    /**
     * Gets the value of the zuMSV property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the zuMSV property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getZuMSV().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getZuMSV() {
        if (zuMSV == null) {
            zuMSV = new ArrayList<ObjectRefType>();
        }
        return this.zuMSV;
    }
