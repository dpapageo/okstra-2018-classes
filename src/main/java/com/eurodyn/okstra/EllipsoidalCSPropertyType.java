...
public class EllipsoidalCSPropertyType {
    ...
    @XmlElementRef(name = "EllipsoidalCS", namespace = "http://www.opengis.net/gml/3.2", type = CoordinateSystemsEllipsoidalCS.class, required = false)
    protected CoordinateSystemsEllipsoidalCS ellipsoidalCS;
     ...
     *     
     */
    public CoordinateSystemsEllipsoidalCS getEllipsoidalCS() {
     ...
     *     
     */
    public void setEllipsoidalCS(CoordinateSystemsEllipsoidalCS value) {
