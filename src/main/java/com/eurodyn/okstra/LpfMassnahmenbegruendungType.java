...
/**
 * <p>Java class for Lpf_MassnahmenbegruendungType complex type.
 * 
 ...
 *         &lt;element name="notwendige_Strukturen" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="Anforderungen_an_die_Lage" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 ...
 *         &lt;element name="verweist_auf_Konflikt" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "Lpf_MassnahmenbegruendungType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    "referenziertFremddatenbestand",
    "referenziertFremdobjekt",
    "zuKommunikationsobjekt",
    "notwendigeStrukturen",
    "anforderungenAnDieLage",
    "zuMassnahme",
    "verweistAufKonflikt",
    "zuMassnahmenkomplex"
})
public class LpfMassnahmenbegruendungType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "notwendige_Strukturen")
    protected String notwendigeStrukturen;
    @XmlElement(name = "Anforderungen_an_die_Lage")
    protected String anforderungenAnDieLage;
    @XmlElement(name = "zu_Massnahme")
    protected List<ObjectRefType> zuMassnahme;
    @XmlElement(name = "verweist_auf_Konflikt")
    protected List<ObjectRefType> verweistAufKonflikt;
    @XmlElement(name = "zu_Massnahmenkomplex")
    protected List<ObjectRefType> zuMassnahmenkomplex;
    ...
    /**
     * Gets the value of the notwendigeStrukturen property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getNotwendigeStrukturen() {
        return notwendigeStrukturen;
    }

    /**
     * Sets the value of the notwendigeStrukturen property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setNotwendigeStrukturen(String value) {
        this.notwendigeStrukturen = value;
    }

    /**
     * Gets the value of the anforderungenAnDieLage property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getAnforderungenAnDieLage() {
        return anforderungenAnDieLage;
    }

    /**
     * Sets the value of the anforderungenAnDieLage property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAnforderungenAnDieLage(String value) {
        this.anforderungenAnDieLage = value;
    }
    ...
    /**
     * Gets the value of the verweistAufKonflikt property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the verweistAufKonflikt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVerweistAufKonflikt().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getVerweistAufKonflikt() {
        if (verweistAufKonflikt == null) {
            verweistAufKonflikt = new ArrayList<ObjectRefType>();
        }
        return this.verweistAufKonflikt;
    }

    /**
     * Gets the value of the zuMassnahmenkomplex property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the zuMassnahmenkomplex property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getZuMassnahmenkomplex().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getZuMassnahmenkomplex() {
        if (zuMassnahmenkomplex == null) {
            zuMassnahmenkomplex = new ArrayList<ObjectRefType>();
        }
        return this.zuMassnahmenkomplex;
    }
