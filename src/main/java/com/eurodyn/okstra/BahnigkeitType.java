...
/**
 * <p>Java class for BahnigkeitType complex type.
 * 
 ...
 *         &lt;element name="Kennzeichen_Bahnigkeit" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "BahnigkeitType", propOrder = {
    "rest"
})
public class BahnigkeitType
    extends AbstractFeatureType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "Kennzeichen_Bahnigkeit", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
     ...
     * line 152 of file:/C:/repo/SIB-BW2-deliverypatch/SIB-BW2/okstra-2018-classes/src/main/resources/lib/oklabi/schema/2018.2/S_Bauliche_Strasseneigenschaften.xsd
