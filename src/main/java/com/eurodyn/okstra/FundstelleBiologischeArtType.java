...
/**
 * <p>Java class for Fundstelle_biologische_ArtType complex type.
 * 
 ...
 *         &lt;element name="von_biologischer_Art" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Fundstelle_biologische_ArtType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class FundstelleBiologischeArtType
    extends AbstractFeatureType
{
    ...
    protected List<ObjectRefType> vonBiologischerArt;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the vonBiologischerArt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVonBiologischerArt().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getVonBiologischerArt() {
        if (vonBiologischerArt == null) {
            vonBiologischerArt = new ArrayList<ObjectRefType>();
        }
        return this.vonBiologischerArt;
    }
