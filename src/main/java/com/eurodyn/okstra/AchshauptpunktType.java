...
/**
 * <p>Java class for AchshauptpunktType complex type.
 * 
 ...
 *         &lt;element name="Ende_von_Achselement" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Beginn_von_Achselement" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AchshauptpunktType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    "punktgeometrie",
    "endeVonAchselement",
    "beginnVonAchselement"
})
public class AchshauptpunktType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Ende_von_Achselement")
    protected List<ObjectRefType> endeVonAchselement;
    @XmlElement(name = "Beginn_von_Achselement")
    protected List<ObjectRefType> beginnVonAchselement;
    ...
    /**
     * Gets the value of the endeVonAchselement property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the endeVonAchselement property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEndeVonAchselement().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getEndeVonAchselement() {
        if (endeVonAchselement == null) {
            endeVonAchselement = new ArrayList<ObjectRefType>();
        }
        return this.endeVonAchselement;
    }

    /**
     * Gets the value of the beginnVonAchselement property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the beginnVonAchselement property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBeginnVonAchselement().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getBeginnVonAchselement() {
        if (beginnVonAchselement == null) {
            beginnVonAchselement = new ArrayList<ObjectRefType>();
        }
        return this.beginnVonAchselement;
    }
