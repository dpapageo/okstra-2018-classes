...
/**
 * <p>Java class for Aufstellvorrichtung_SchildType complex type.
 * 
 ...
 *         &lt;element name="Nummer_Aufstellvorrichtung" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="Abstand_linker_Pfosten" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Meter" minOccurs="0"/&gt;
 *         &lt;element name="Abstand_rechter_Pfosten" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Meter" minOccurs="0"/&gt;
 *         &lt;element name="Position_linker_Pfosten" type="{http://www.opengis.net/gml/3.2}PointPropertyType" minOccurs="0"/&gt;
 *         &lt;element name="Position_rechter_Pfosten" type="{http://www.opengis.net/gml/3.2}PointPropertyType" minOccurs="0"/&gt;
 *         &lt;element name="Lage" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" minOccurs="0"/&gt;
 *         &lt;element name="Art" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" minOccurs="0"/&gt;
 *         &lt;element name="Durchmesser" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Millimeter" minOccurs="0"/&gt;
 ...
 *         &lt;element name="hat_Schild" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "Aufstellvorrichtung_SchildType", propOrder = {
    "rest"
})
public class AufstellvorrichtungSchildType
    extends AbstractFeatureType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "Position_linker_Pfosten", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Nummer_Aufstellvorrichtung", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Position_rechter_Pfosten", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Abstand_rechter_Pfosten", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "hat_Schild", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Durchmesser", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Abstand_linker_Pfosten", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
     ...
     * line 23 of file:/C:/repo/SIB-BW2-deliverypatch/SIB-BW2/okstra-2018-classes/src/main/resources/lib/oklabi/schema/2018.2/S_Statische_Beschilderung.xsd
