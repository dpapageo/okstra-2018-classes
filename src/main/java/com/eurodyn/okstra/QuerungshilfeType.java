...
/**
 * <p>Java class for QuerungshilfeType complex type.
 * 
...
@XmlType(name = "QuerungshilfeType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    "tmcPunktobjekt",
    "gehoertZuUeberweg",
    "stelltTeilhindernisDar"
})
public class QuerungshilfeType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "stellt_Teilhindernis_dar")
    protected List<ObjectRefType> stelltTeilhindernisDar;
    ...
    /**
     * Gets the value of the stelltTeilhindernisDar property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the stelltTeilhindernisDar property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStelltTeilhindernisDar().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getStelltTeilhindernisDar() {
        if (stelltTeilhindernisDar == null) {
            stelltTeilhindernisDar = new ArrayList<ObjectRefType>();
        }
        return this.stelltTeilhindernisDar;
    }
