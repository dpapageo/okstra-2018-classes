...
/**
 * <p>Java class for Prueffahrzeug_PruefgeraetType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Prueffahrzeug_PruefgeraetType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Geraeteart" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType"/&gt;
 *         &lt;element name="Voraussichtliche_Dauer_des_Einsatzes" type="{http://www.okstra.de/okstra/2.018.2}DauerPropertyType" minOccurs="0"/&gt;
 *         &lt;element name="Geschaetzte_Kosten_des_Einsatzes" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}EURO" minOccurs="0"/&gt;
...
@XmlType(name = "Prueffahrzeug_PruefgeraetType", propOrder = {
    "rest"
})
public class PrueffahrzeugPruefgeraetType
    extends AbstractFeatureType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "Voraussichtliche_Dauer_des_Einsatzes", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Geschaetzte_Kosten_des_Einsatzes", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Geraeteart", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
     ...
     * line 2433 of file:/C:/repo/SIB-BW2-deliverypatch/SIB-BW2/okstra-2018-classes/src/main/resources/lib/oklabi/schema/2018.2/S_Bauwerke.xsd
