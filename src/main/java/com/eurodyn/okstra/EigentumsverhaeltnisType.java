...
/**
 * <p>Java class for EigentumsverhaeltnisType complex type.
 * 
 ...
 *         &lt;element name="Eigentumsverhaeltnis" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "EigentumsverhaeltnisType", propOrder = {
    "kennung",
    "eigentumsverhaeltnis"
})
public class EigentumsverhaeltnisType
    extends AbstractFeatureType
{

    @XmlElement(name = "Kennung", required = true)
    protected String kennung;
    @XmlElement(name = "Eigentumsverhaeltnis", required = true)
