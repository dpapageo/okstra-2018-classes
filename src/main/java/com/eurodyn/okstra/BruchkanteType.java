...
/**
 * <p>Java class for BruchkanteType complex type.
 * 
 ...
 *         &lt;element name="in_DGM" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" minOccurs="0"/&gt;
 *         &lt;element name="hat_Punkt" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="2"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "BruchkanteType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "in_DGM")
    protected ObjectRefType inDGM;
    @XmlElement(name = "hat_Punkt", required = true)
    protected List<ObjectRefType> hatPunkt;
    ...
    /**
     * Gets the value of the hatPunkt property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatPunkt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatPunkt().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatPunkt() {
        if (hatPunkt == null) {
            hatPunkt = new ArrayList<ObjectRefType>();
        }
        return this.hatPunkt;
    }
