...
@XmlType(name = "ImageDatumPropertyType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
    "imageDatum"
})
public class ImageDatumPropertyType {

    @XmlElementRef(name = "ImageDatum", namespace = "http://www.opengis.net/gml/3.2", type = DatumsImageDatum.class, required = false)
    protected DatumsImageDatum imageDatum;
     ...
     *     
     */
    public DatumsImageDatum getImageDatum() {
        return imageDatum;
    }
     ...
     *     
     */
    public void setImageDatum(DatumsImageDatum value) {
