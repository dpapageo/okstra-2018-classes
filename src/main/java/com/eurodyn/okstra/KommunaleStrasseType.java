...
/**
 * <p>Java class for kommunale_StrasseType complex type.
 * 
 ...
 *         &lt;element name="Strassenschluessel" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="Lage" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="hat_Segment_kommunale_Strasse" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="in_Gemeinde" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "kommunale_StrasseType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    "strassenschluessel",
    "lage",
    "hatSegmentKommunaleStrasse",
    "hatStrassenbezugsobjekt",
    "inGemeinde"
})
public class KommunaleStrasseType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Strassenschluessel")
    protected String strassenschluessel;
    @XmlElement(name = "Lage")
    protected String lage;
    @XmlElement(name = "hat_Segment_kommunale_Strasse")
    protected List<ObjectRefType> hatSegmentKommunaleStrasse;
    @XmlElement(name = "hat_Strassenbezugsobjekt")
    protected List<ObjectRefType> hatStrassenbezugsobjekt;
    @XmlElement(name = "in_Gemeinde")
    protected List<ObjectRefType> inGemeinde;
    ...
    /**
     * Gets the value of the strassenschluessel property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the strassenschluessel property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setStrassenschluessel(String value) {
        this.strassenschluessel = value;
    }
    ...
    /**
     * Gets the value of the hatSegmentKommunaleStrasse property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatSegmentKommunaleStrasse property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatSegmentKommunaleStrasse().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatSegmentKommunaleStrasse() {
        if (hatSegmentKommunaleStrasse == null) {
            hatSegmentKommunaleStrasse = new ArrayList<ObjectRefType>();
        }
        return this.hatSegmentKommunaleStrasse;
    }
    ...
    /**
     * Gets the value of the inGemeinde property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the inGemeinde property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInGemeinde().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getInGemeinde() {
        if (inGemeinde == null) {
            inGemeinde = new ArrayList<ObjectRefType>();
        }
        return this.inGemeinde;
    }
