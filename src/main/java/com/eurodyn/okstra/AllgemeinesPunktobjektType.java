...
/**
 * <p>Java class for allgemeines_PunktobjektType complex type.
 * 
 ...
 *         &lt;element name="Punktnummer" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="fachliche_Bedeutung" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *         &lt;element name="DGM_proprietaer" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="in_Dreieck" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="hat_Symbol" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="in_Bruchkante" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "allgemeines_PunktobjektType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class AllgemeinesPunktobjektType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Punktnummer")
    protected String punktnummer;
    @XmlElement(name = "fachliche_Bedeutung", required = true)
    protected String fachlicheBedeutung;
    @XmlElement(name = "DGM_proprietaer")
    protected Boolean dgmProprietaer;
    @XmlElement(name = "in_Dreieck")
    protected List<ObjectRefType> inDreieck;
    @XmlElement(name = "hat_Symbol")
    protected List<ObjectRefType> hatSymbol;
    @XmlElement(name = "in_Bruchkante")
    protected List<ObjectRefType> inBruchkante;
    ...
    /**
     * Gets the value of the dgmProprietaer property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isDGMProprietaer() {
        return dgmProprietaer;
    }

    /**
     * Sets the value of the dgmProprietaer property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setDGMProprietaer(Boolean value) {
        this.dgmProprietaer = value;
    }

    /**
     * Gets the value of the inDreieck property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the inDreieck property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInDreieck().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getInDreieck() {
        if (inDreieck == null) {
            inDreieck = new ArrayList<ObjectRefType>();
        }
        return this.inDreieck;
    }

    /**
     * Gets the value of the hatSymbol property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatSymbol property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatSymbol().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatSymbol() {
        if (hatSymbol == null) {
            hatSymbol = new ArrayList<ObjectRefType>();
        }
        return this.hatSymbol;
    }

    /**
     * Gets the value of the inBruchkante property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the inBruchkante property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInBruchkante().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getInBruchkante() {
        if (inBruchkante == null) {
            inBruchkante = new ArrayList<ObjectRefType>();
        }
        return this.inBruchkante;
    }
