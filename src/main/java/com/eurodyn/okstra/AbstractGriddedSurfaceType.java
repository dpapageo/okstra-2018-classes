...
@XmlType(name = "AbstractGriddedSurfaceType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
    "rows"
})
@XmlSeeAlso({
    ConeType.class,
    ...
    extends AbstractParametricCurveSurfaceType
{
    ...
    protected BigInteger geometryPrimitivesAttributeRows;
    ...
    /**
     * Gets the value of the geometryPrimitivesAttributeRows property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getGeometryPrimitivesAttributeRows() {
        return geometryPrimitivesAttributeRows;
    }

    /**
     * Sets the value of the geometryPrimitivesAttributeRows property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setGeometryPrimitivesAttributeRows(BigInteger value) {
        this.geometryPrimitivesAttributeRows = value;
    }
    ...
    public static class Rows {
        ...
        @XmlElement(name = "Row", namespace = "http://www.opengis.net/gml/3.2")
