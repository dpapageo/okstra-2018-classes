...
/**
 * <p>Java class for Wirkungsbereich_SPType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Wirkungsbereich_SPType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Beginn_von_RW_Wirkunsbereich" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Ende_von_RW_Wirkunsbereich" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Ende_von_SB_Wirkunsbereich" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Beginn_von_SB_Wirkunsbereich" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Wirkungsbereich_SPType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    "openLRPunktobjekt",
    "tmcPunktobjekt",
    "beginnVonRWWirkunsbereich",
    "endeVonRWWirkunsbereich",
    "endeVonSBWirkunsbereich",
    "beginnVonSBWirkunsbereich"
})
public class WirkungsbereichSPType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Beginn_von_RW_Wirkunsbereich")
    protected List<ObjectRefType> beginnVonRWWirkunsbereich;
    @XmlElement(name = "Ende_von_RW_Wirkunsbereich")
    protected List<ObjectRefType> endeVonRWWirkunsbereich;
    @XmlElement(name = "Ende_von_SB_Wirkunsbereich")
    protected List<ObjectRefType> endeVonSBWirkunsbereich;
    @XmlElement(name = "Beginn_von_SB_Wirkunsbereich")
    protected List<ObjectRefType> beginnVonSBWirkunsbereich;
    ...
    /**
     * Gets the value of the beginnVonRWWirkunsbereich property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the beginnVonRWWirkunsbereich property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBeginnVonRWWirkunsbereich().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getBeginnVonRWWirkunsbereich() {
        if (beginnVonRWWirkunsbereich == null) {
            beginnVonRWWirkunsbereich = new ArrayList<ObjectRefType>();
        }
        return this.beginnVonRWWirkunsbereich;
    }

    /**
     * Gets the value of the endeVonRWWirkunsbereich property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the endeVonRWWirkunsbereich property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEndeVonRWWirkunsbereich().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getEndeVonRWWirkunsbereich() {
        if (endeVonRWWirkunsbereich == null) {
            endeVonRWWirkunsbereich = new ArrayList<ObjectRefType>();
        }
        return this.endeVonRWWirkunsbereich;
    }

    /**
     * Gets the value of the endeVonSBWirkunsbereich property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the endeVonSBWirkunsbereich property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEndeVonSBWirkunsbereich().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getEndeVonSBWirkunsbereich() {
        if (endeVonSBWirkunsbereich == null) {
            endeVonSBWirkunsbereich = new ArrayList<ObjectRefType>();
        }
        return this.endeVonSBWirkunsbereich;
    }

    /**
     * Gets the value of the beginnVonSBWirkunsbereich property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the beginnVonSBWirkunsbereich property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBeginnVonSBWirkunsbereich().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getBeginnVonSBWirkunsbereich() {
        if (beginnVonSBWirkunsbereich == null) {
            beginnVonSBWirkunsbereich = new ArrayList<ObjectRefType>();
        }
        return this.beginnVonSBWirkunsbereich;
    }
