...
public class CartesianCSPropertyType {
    ...
    @XmlElementRef(name = "CartesianCS", namespace = "http://www.opengis.net/gml/3.2", type = CoordinateSystemsCartesianCS.class, required = false)
    protected CoordinateSystemsCartesianCS cartesianCS;
     ...
     *     
     */
    public CoordinateSystemsCartesianCS getCartesianCS() {
        return cartesianCS;
    }
     ...
     *     
     */
    public void setCartesianCS(CoordinateSystemsCartesianCS value) {
