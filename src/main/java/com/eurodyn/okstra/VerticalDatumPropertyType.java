...
public class VerticalDatumPropertyType {
    ...
    @XmlElementRef(name = "VerticalDatum", namespace = "http://www.opengis.net/gml/3.2", type = DatumsVerticalDatum.class, required = false)
    protected DatumsVerticalDatum verticalDatum;
     ...
     *     
     */
    public DatumsVerticalDatum getVerticalDatum() {
     ...
     *     
     */
    public void setVerticalDatum(DatumsVerticalDatum value) {
