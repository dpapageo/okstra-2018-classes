...
@XmlType(name = "ClothoidType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
    "refLocation",
    "scaleFactor",
    "startParameter",
    "endParameter"
    ...
    extends AbstractCurveSegmentType
{
    ...
    public static class RefLocation {
        ...
        @XmlElement(name = "AffinePlacement", namespace = "http://www.opengis.net/gml/3.2", required = true)
