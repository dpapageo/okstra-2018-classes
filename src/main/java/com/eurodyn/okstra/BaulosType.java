...
/**
 * <p>Java class for BaulosType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BaulosType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Nr_Baulos" type="{http://www.w3.org/2001/XMLSchema}integer" minOccurs="0"/&gt;
 *         &lt;element name="hat_Baulosbeteiligung" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Teil_von_Kostendaten" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="zu_Teil" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "BaulosType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    "bezeichnung",
    "nrBaulos",
    "hatBaulosbeteiligung",
    "teilVonKostendaten",
    "zuTeil"
})
public class BaulosType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Nr_Baulos")
    protected BigInteger nrBaulos;
    @XmlElement(name = "hat_Baulosbeteiligung")
    protected List<ObjectRefType> hatBaulosbeteiligung;
    @XmlElement(name = "Teil_von_Kostendaten", required = true)
    protected List<ObjectRefType> teilVonKostendaten;
    @XmlElement(name = "zu_Teil")
    protected List<ObjectRefType> zuTeil;
    ...
    /**
     * Gets the value of the nrBaulos property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getNrBaulos() {
        return nrBaulos;
    }

    /**
     * Sets the value of the nrBaulos property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setNrBaulos(BigInteger value) {
        this.nrBaulos = value;
    }

    /**
     * Gets the value of the hatBaulosbeteiligung property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatBaulosbeteiligung property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatBaulosbeteiligung().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatBaulosbeteiligung() {
        if (hatBaulosbeteiligung == null) {
            hatBaulosbeteiligung = new ArrayList<ObjectRefType>();
        }
        return this.hatBaulosbeteiligung;
    }
    ...
    /**
     * Gets the value of the zuTeil property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the zuTeil property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getZuTeil().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getZuTeil() {
        if (zuTeil == null) {
            zuTeil = new ArrayList<ObjectRefType>();
        }
        return this.zuTeil;
    }
