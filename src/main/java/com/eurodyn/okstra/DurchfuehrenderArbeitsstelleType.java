...
/**
 * <p>Java class for Durchfuehrender_ArbeitsstelleType complex type.
 * 
 ...
 *         &lt;element name="hat_Firma" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Durchfuehrender_ArbeitsstelleType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class DurchfuehrenderArbeitsstelleType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "hat_Baudienststelle")
    protected List<ObjectRefType> hatBaudienststelle;
    @XmlElement(name = "zu_Arbeitsstelle", required = true)
    protected ObjectRefType zuArbeitsstelle;
    @XmlElement(name = "hat_Firma")
    protected ObjectRefType hatFirma;
    ...
    /**
     * Gets the value of the hatBaudienststelle property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatBaudienststelle property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatBaudienststelle().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatBaudienststelle() {
        if (hatBaudienststelle == null) {
            hatBaudienststelle = new ArrayList<ObjectRefType>();
        }
        return this.hatBaudienststelle;
    }
    ...
    /**
     * Gets the value of the hatFirma property.
     * 
     * @return
     *     possible object is
     *     {@link ObjectRefType }
     *     
     */
    public ObjectRefType getHatFirma() {
        return hatFirma;
    }

    /**
     * Sets the value of the hatFirma property.
     * 
     * @param value
     *     allowed object is
     *     {@link ObjectRefType }
     *     
     */
    public void setHatFirma(ObjectRefType value) {
        this.hatFirma = value;
    }
