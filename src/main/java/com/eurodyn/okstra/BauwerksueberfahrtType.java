...
/**
 * <p>Java class for BauwerksueberfahrtType complex type.
 * 
 ...
 *         &lt;element name="ueber_Teilbauwerk" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="hat_Teilbauwerksergebnis" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="zu_Schwertransport" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "BauwerksueberfahrtType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    "richtung",
    "ueberTeilbauwerk",
    "hatTeilbauwerksergebnis",
    "zuSchwertransport"
})
public class BauwerksueberfahrtType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "ueber_Teilbauwerk", required = true)
    protected List<ObjectRefType> ueberTeilbauwerk;
    @XmlElement(name = "hat_Teilbauwerksergebnis")
    protected List<ObjectRefType> hatTeilbauwerksergebnis;
    @XmlElement(name = "zu_Schwertransport")
    protected ObjectRefType zuSchwertransport;
    ...
    /**
     * Gets the value of the ueberTeilbauwerk property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the ueberTeilbauwerk property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUeberTeilbauwerk().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getUeberTeilbauwerk() {
        if (ueberTeilbauwerk == null) {
            ueberTeilbauwerk = new ArrayList<ObjectRefType>();
        }
        return this.ueberTeilbauwerk;
    }

    /**
     * Gets the value of the hatTeilbauwerksergebnis property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatTeilbauwerksergebnis property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatTeilbauwerksergebnis().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatTeilbauwerksergebnis() {
        if (hatTeilbauwerksergebnis == null) {
            hatTeilbauwerksergebnis = new ArrayList<ObjectRefType>();
        }
        return this.hatTeilbauwerksergebnis;
    }

    /**
     * Gets the value of the zuSchwertransport property.
     * 
     * @return
     *     possible object is
     *     {@link ObjectRefType }
     *     
     */
    public ObjectRefType getZuSchwertransport() {
        return zuSchwertransport;
    }

    /**
     * Sets the value of the zuSchwertransport property.
     * 
     * @param value
     *     allowed object is
     *     {@link ObjectRefType }
     *     
     */
    public void setZuSchwertransport(ObjectRefType value) {
        this.zuSchwertransport = value;
    }
