...
/**
 * <p>Java class for EreignisPropertyType complex type.
 * 
 ...
 *         &lt;element ref="{http://www.okstra.de/okstra/2.018.2}Ereignis"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "EreignisPropertyType", propOrder = {
    "ereignis"
})
public class EreignisPropertyType {

    @XmlElement(name = "Ereignis")
    protected EreignisType ereignis;
     ...
     *     
     */
    public EreignisType getEreignis() {
        return ereignis;
    }

    /**
     * Sets the value of the ereignis property.
     * 
     * @param value
     *     allowed object is
     *     {@link EreignisType }
     *     
     */
    public void setEreignis(EreignisType value) {
        this.ereignis = value;
    }
