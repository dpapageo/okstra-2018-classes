...
/**
 * <p>Java class for BodenType complex type.
 * 
 ...
 *         &lt;element name="Bodenart" type="{http://www.okstra.de/okstra/2.018.2}BodenartPropertyType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "BodenType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Bodenart", required = true)
    protected List<BodenartPropertyType> bodenart;
    ...
    /**
     * Gets the value of the bodenart property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the bodenart property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBodenart().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BodenartPropertyType }
     * 
     * 
     */
    public List<BodenartPropertyType> getBodenart() {
        if (bodenart == null) {
            bodenart = new ArrayList<BodenartPropertyType>();
        }
