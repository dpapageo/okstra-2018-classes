...
/**
 * <p>Java class for DeckenbuchType complex type.
 * 
 ...
 *         &lt;element name="Station_1" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Meter"/&gt;
 *         &lt;element name="Station_2" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Meter"/&gt;
 *         &lt;element name="gehoert_zu_Achse" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType"/&gt;
 *         &lt;element name="hat_verallg_Spur" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "DeckenbuchType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Station_1", required = true)
    protected Meter station1;
    @XmlElement(name = "Station_2", required = true)
    protected Meter station2;
    @XmlElement(name = "gehoert_zu_Achse", required = true)
    protected ObjectRefType gehoertZuAchse;
    @XmlElement(name = "hat_verallg_Spur", required = true)
    protected List<ObjectRefType> hatVerallgSpur;
    ...
    /**
     * Gets the value of the station1 property.
     * 
     * @return
     *     possible object is
     *     {@link Meter }
     *     
     */
    public Meter getStation1() {
        return station1;
    }

    /**
     * Sets the value of the station1 property.
     * 
     * @param value
     *     allowed object is
     *     {@link Meter }
     *     
     */
    public void setStation1(Meter value) {
        this.station1 = value;
    }

    /**
     * Gets the value of the station2 property.
     * 
     * @return
     *     possible object is
     *     {@link Meter }
     *     
     */
    public Meter getStation2() {
        return station2;
    }

    /**
     * Sets the value of the station2 property.
     * 
     * @param value
     *     allowed object is
     *     {@link Meter }
     *     
     */
    public void setStation2(Meter value) {
        this.station2 = value;
    }
    ...
    /**
     * Gets the value of the hatVerallgSpur property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatVerallgSpur property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatVerallgSpur().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatVerallgSpur() {
        if (hatVerallgSpur == null) {
            hatVerallgSpur = new ArrayList<ObjectRefType>();
        }
        return this.hatVerallgSpur;
    }
