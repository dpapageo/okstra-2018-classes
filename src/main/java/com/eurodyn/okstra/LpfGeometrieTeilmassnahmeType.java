...
/**
 * <p>Java class for Lpf_Geometrie_TeilmassnahmeType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Lpf_Geometrie_TeilmassnahmeType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Groesse" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Quadratmeter"/&gt;
 ...
 *         &lt;element name="zu_Teilmassnahme" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Lpf_Geometrie_TeilmassnahmeType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class LpfGeometrieTeilmassnahmeType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Groesse", required = true)
    protected Quadratmeter groesse;
    @XmlElement(name = "auf_Flurstueck")
    protected List<ObjectRefType> aufFlurstueck;
    @XmlElement(name = "zu_Teilmassnahme", required = true)
    protected ObjectRefType zuTeilmassnahme;
     ...
     *     
     */
    public Quadratmeter getGroesse() {
        return groesse;
    }
     ...
     *     
     */
    public void setGroesse(Quadratmeter value) {
        this.groesse = value;
    }

    /**
     * Gets the value of the aufFlurstueck property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the aufFlurstueck property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAufFlurstueck().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getAufFlurstueck() {
        if (aufFlurstueck == null) {
            aufFlurstueck = new ArrayList<ObjectRefType>();
        }
        return this.aufFlurstueck;
    }

    /**
     * Gets the value of the zuTeilmassnahme property.
     * 
     * @return
     *     possible object is
     *     {@link ObjectRefType }
     *     
     */
    public ObjectRefType getZuTeilmassnahme() {
        return zuTeilmassnahme;
    }

    /**
     * Sets the value of the zuTeilmassnahme property.
     * 
     * @param value
     *     allowed object is
     *     {@link ObjectRefType }
     *     
     */
    public void setZuTeilmassnahme(ObjectRefType value) {
        this.zuTeilmassnahme = value;
    }
