...
/**
 * <p>Java class for BahnkreuzungType complex type.
 * 
 ...
 *         &lt;element name="Bahnkreuzungsart" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType"/&gt;
 *         &lt;element name="elektrifiziert" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" minOccurs="0"/&gt;
 *         &lt;element name="Bahnkreuzungsstadium" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" minOccurs="0"/&gt;
 *         &lt;element name="Beruehrungsebene" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType"/&gt;
 *         &lt;element name="Bahnkreuzungslage" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" minOccurs="0"/&gt;
 *         &lt;element name="Bahnkoerper" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" minOccurs="0"/&gt;
 *         &lt;element name="Bahnkreuzung_Sicherungsart" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" minOccurs="0"/&gt;
 *         &lt;element name="Gleisanzahl" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Anzahl" minOccurs="0"/&gt;
 *         &lt;element name="Bahnkilometer" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Kilometer" minOccurs="0"/&gt;
 *         &lt;element name="Streckenbezeichnung" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "BahnkreuzungType", propOrder = {
    "rest"
})
public class BahnkreuzungType
    extends AbstractFeatureType
{

    @XmlElementRefs({
        @XmlElementRef(name = "Streckenbezeichnung", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Bahnkoerper", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Gleisanzahl", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "elektrifiziert", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Bahnkreuzung_Sicherungsart", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "hat_Objekt_ID", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Bahnkilometer", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Bahnkreuzungsart", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Bahnkreuzungsstadium", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Bahnkreuzungslage", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
     ...
     * line 18 of file:/C:/repo/SIB-BW2-deliverypatch/SIB-BW2/okstra-2018-classes/src/main/resources/lib/oklabi/schema/2018.2/S_Kreuzungen.xsd
