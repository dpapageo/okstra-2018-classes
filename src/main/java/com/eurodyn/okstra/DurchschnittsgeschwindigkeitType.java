...
/**
 * <p>Java class for DurchschnittsgeschwindigkeitType complex type.
 * 
 ...
 *         &lt;element name="km_h" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Stundenkilometer"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "DurchschnittsgeschwindigkeitType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class DurchschnittsgeschwindigkeitType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "km_h", required = true)
    protected Stundenkilometer kmH;
    ...
    /**
     * Gets the value of the kmH property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public Stundenkilometer getKmH() {
        return kmH;
    }

    /**
     * Sets the value of the kmH property.
     * 
     * @param value
     *     allowed object is
     *     {@link Stundenkilometer }
     *     
     */
    public void setKmH(Stundenkilometer value) {
        this.kmH = value;
    }
