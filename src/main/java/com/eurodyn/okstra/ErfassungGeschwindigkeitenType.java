...
/**
 * <p>Java class for Erfassung_GeschwindigkeitenType complex type.
 * 
 ...
 *         &lt;element name="zugehoerige_Fahrzeugklasse" type="{http://www.w3.org/2001/XMLSchema}integer"/&gt;
 *         &lt;element name="hat_aggregierte_Werte" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="hat_V_Verteilungen" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Erfassung_GeschwindigkeitenType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    "referenziertFremddatenbestand",
    "referenziertFremdobjekt",
    "zuKommunikationsobjekt",
    "zugehoerigeFahrzeugklasse",
    "hatAggregierteWerte",
    "hatVVerteilungen"
})
public class ErfassungGeschwindigkeitenType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "zugehoerige_Fahrzeugklasse", required = true)
    protected BigInteger zugehoerigeFahrzeugklasse;
    @XmlElement(name = "hat_aggregierte_Werte", required = true)
    protected List<ObjectRefType> hatAggregierteWerte;
    @XmlElement(name = "hat_V_Verteilungen")
    protected List<ObjectRefType> hatVVerteilungen;
    ...
    /**
     * Gets the value of the zugehoerigeFahrzeugklasse property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getZugehoerigeFahrzeugklasse() {
        return zugehoerigeFahrzeugklasse;
    }

    /**
     * Sets the value of the zugehoerigeFahrzeugklasse property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setZugehoerigeFahrzeugklasse(BigInteger value) {
        this.zugehoerigeFahrzeugklasse = value;
    }

    /**
     * Gets the value of the hatAggregierteWerte property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatAggregierteWerte property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatAggregierteWerte().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatAggregierteWerte() {
        if (hatAggregierteWerte == null) {
            hatAggregierteWerte = new ArrayList<ObjectRefType>();
        }
        return this.hatAggregierteWerte;
    }

    /**
     * Gets the value of the hatVVerteilungen property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatVVerteilungen property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatVVerteilungen().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatVVerteilungen() {
        if (hatVVerteilungen == null) {
            hatVVerteilungen = new ArrayList<ObjectRefType>();
        }
        return this.hatVVerteilungen;
    }
