...
@XmlType(name = "PolarCSPropertyType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
    "polarCS"
})
public class PolarCSPropertyType {

    @XmlElementRef(name = "PolarCS", namespace = "http://www.opengis.net/gml/3.2", type = CoordinateSystemsPolarCS.class, required = false)
    protected CoordinateSystemsPolarCS polarCS;
     ...
     *     
     */
    public CoordinateSystemsPolarCS getPolarCS() {
        return polarCS;
    }
     ...
     *     
     */
    public void setPolarCS(CoordinateSystemsPolarCS value) {
        this.polarCS = value;
    }
