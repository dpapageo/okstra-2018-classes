...
@XmlType(name = "AffineCSPropertyType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
    "affineCS"
})
public class AffineCSPropertyType {

    @XmlElementRef(name = "AffineCS", namespace = "http://www.opengis.net/gml/3.2", type = CoordinateSystemsAffineCS.class, required = false)
    protected CoordinateSystemsAffineCS affineCS;
     ...
     *     
     */
    public CoordinateSystemsAffineCS getAffineCS() {
        return affineCS;
    }
     ...
     *     
     */
    public void setAffineCS(CoordinateSystemsAffineCS value) {
        this.affineCS = value;
    }
