...
/**
 * <p>Java class for BiotopkomplexType complex type.
 * 
 ...
 *         &lt;element name="besteht_aus_Biotop" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "BiotopkomplexType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class BiotopkomplexType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "besteht_aus_Biotop", required = true)
    protected List<ObjectRefType> bestehtAusBiotop;
    ...
    /**
     * Gets the value of the bestehtAusBiotop property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the bestehtAusBiotop property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBestehtAusBiotop().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getBestehtAusBiotop() {
        if (bestehtAusBiotop == null) {
            bestehtAusBiotop = new ArrayList<ObjectRefType>();
        }
        return this.bestehtAusBiotop;
    }
