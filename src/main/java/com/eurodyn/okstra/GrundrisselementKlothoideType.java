...
/**
 * <p>Java class for Grundrisselement_KlothoideType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Grundrisselement_KlothoideType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Richtungsw_Tangente_am_Anfang" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Gon" minOccurs="0"/&gt;
 *         &lt;element name="Radius_am_Anfang" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Meter" minOccurs="0"/&gt;
 *         &lt;element name="Radius_am_Ende" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Meter" minOccurs="0"/&gt;
 *         &lt;element name="Parameter" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Meter"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Grundrisselement_KlothoideType", propOrder = {
    "rest"
})
public class GrundrisselementKlothoideType
    extends AbstractFeatureType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "Richtungsw_Tangente_am_Anfang", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Radius_am_Anfang", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Parameter", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Radius_am_Ende", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
     ...
     * line 485 of file:/C:/repo/SIB-BW2-deliverypatch/SIB-BW2/okstra-2018-classes/src/main/resources/lib/oklabi/schema/2018.2/S_Bauliche_Strasseneigenschaften.xsd
