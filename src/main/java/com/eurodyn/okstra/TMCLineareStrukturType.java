...
/**
 * <p>Java class for TMC_Lineare_StrukturType complex type.
 * 
 ...
 *         &lt;element name="verbunden_mit" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "TMC_Lineare_StrukturType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class TMCLineareStrukturType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "verbunden_mit")
    protected List<ObjectRefType> verbundenMit;
    ...
    /**
     * Gets the value of the verbundenMit property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the verbundenMit property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVerbundenMit().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getVerbundenMit() {
        if (verbundenMit == null) {
            verbundenMit = new ArrayList<ObjectRefType>();
        }
        return this.verbundenMit;
    }
