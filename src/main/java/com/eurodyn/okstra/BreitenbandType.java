...
/**
 * <p>Java class for BreitenbandType complex type.
 * 
 ...
 *         &lt;element name="hat_BR_Punkt" type="{http://www.okstra.de/okstra/2.018.2}BR_PunktPropertyType" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "BreitenbandType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "hat_BR_Punkt", required = true)
    protected List<BRPunktPropertyType> hatBRPunkt;
    ...
    /**
     * Gets the value of the hatBRPunkt property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatBRPunkt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatBRPunkt().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BRPunktPropertyType }
     * 
     * 
     */
    public List<BRPunktPropertyType> getHatBRPunkt() {
        if (hatBRPunkt == null) {
            hatBRPunkt = new ArrayList<BRPunktPropertyType>();
        }
        return this.hatBRPunkt;
    }
