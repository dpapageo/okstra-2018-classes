...
@XmlType(name = "ParameterValueGroupType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
    "parameterValue",
    "group"
})
    ...
    extends AbstractGeneralParameterValueType
{
    ...
    @XmlElementRef(name = "parameterValue", namespace = "http://www.opengis.net/gml/3.2", type = CoordinateOperationsparameterValue.class)
