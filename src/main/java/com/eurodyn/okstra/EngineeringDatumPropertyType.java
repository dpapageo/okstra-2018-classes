...
@XmlType(name = "EngineeringDatumPropertyType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
    "engineeringDatum"
})
public class EngineeringDatumPropertyType {

    @XmlElementRef(name = "EngineeringDatum", namespace = "http://www.opengis.net/gml/3.2", type = DatumsEngineeringDatum.class, required = false)
    protected DatumsEngineeringDatum engineeringDatum;
     ...
     *     
     */
    public DatumsEngineeringDatum getEngineeringDatum() {
     ...
     *     
     */
    public void setEngineeringDatum(DatumsEngineeringDatum value) {
