...
/**
 * <p>Java class for GrenzpunktType complex type.
 * 
 ...
 *         &lt;element name="ist_Vermessungspunkt" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "GrenzpunktType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "ist_Vermessungspunkt")
    protected List<ObjectRefType> istVermessungspunkt;
    ...
    /**
     * Gets the value of the istVermessungspunkt property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the istVermessungspunkt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getIstVermessungspunkt().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getIstVermessungspunkt() {
        if (istVermessungspunkt == null) {
            istVermessungspunkt = new ArrayList<ObjectRefType>();
        }
        return this.istVermessungspunkt;
    }
