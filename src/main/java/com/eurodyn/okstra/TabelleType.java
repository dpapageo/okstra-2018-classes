...
/**
 * <p>Java class for TabelleType complex type.
 * 
 ...
 *         &lt;element name="Zeilenzahl" type="{http://www.w3.org/2001/XMLSchema}integer"/&gt;
 *         &lt;element name="Spaltenzahl" type="{http://www.w3.org/2001/XMLSchema}integer"/&gt;
 *         &lt;element name="Schaetzwert" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="Tabellenspalte" type="{http://www.okstra.de/okstra/2.018.2}TabellenspaltePropertyType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Versionsinfo" type="{http://www.okstra.de/okstra/2.018.2}VersionsinfoPropertyType"/&gt;
 *         &lt;element name="definiert_Konstante" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="zu_Zeile" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "TabelleType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Zeilenzahl", required = true)
    protected BigInteger zeilenzahl;
    @XmlElement(name = "Spaltenzahl", required = true)
    protected BigInteger spaltenzahl;
    @XmlElement(name = "Schaetzwert")
    protected Boolean schaetzwert;
    @XmlElement(name = "Tabellenspalte")
    protected List<TabellenspaltePropertyType> tabellenspalte;
    @XmlElement(name = "Versionsinfo", required = true)
    protected VersionsinfoPropertyType versionsinfo;
    @XmlElement(name = "definiert_Konstante")
    protected List<ObjectRefType> definiertKonstante;
    @XmlElement(name = "zu_Zeile", required = true)
    protected ObjectRefType zuZeile;
    ...
    /**
     * Gets the value of the zeilenzahl property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getZeilenzahl() {
        return zeilenzahl;
    }

    /**
     * Sets the value of the zeilenzahl property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setZeilenzahl(BigInteger value) {
        this.zeilenzahl = value;
    }

    /**
     * Gets the value of the spaltenzahl property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getSpaltenzahl() {
        return spaltenzahl;
    }

    /**
     * Sets the value of the spaltenzahl property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setSpaltenzahl(BigInteger value) {
        this.spaltenzahl = value;
    }
    ...
    /**
     * Gets the value of the tabellenspalte property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the tabellenspalte property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTabellenspalte().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TabellenspaltePropertyType }
     * 
     * 
     */
    public List<TabellenspaltePropertyType> getTabellenspalte() {
        if (tabellenspalte == null) {
            tabellenspalte = new ArrayList<TabellenspaltePropertyType>();
        }
        return this.tabellenspalte;
    }
     ...
     * @return
     *     possible object is
     *     {@link VersionsinfoPropertyType }
     *     
     */
    public VersionsinfoPropertyType getVersionsinfo() {
        return versionsinfo;
    }
     ...
     *     
     */
    public void setVersionsinfo(VersionsinfoPropertyType value) {
        this.versionsinfo = value;
    }

    /**
     * Gets the value of the definiertKonstante property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the definiertKonstante property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDefiniertKonstante().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getDefiniertKonstante() {
        if (definiertKonstante == null) {
            definiertKonstante = new ArrayList<ObjectRefType>();
        }
        return this.definiertKonstante;
    }

    /**
     * Gets the value of the zuZeile property.
     * 
     * @return
     *     possible object is
     *     {@link ObjectRefType }
     *     
     */
    public ObjectRefType getZuZeile() {
        return zuZeile;
    }

    /**
     * Sets the value of the zuZeile property.
     * 
     * @param value
     *     allowed object is
     *     {@link ObjectRefType }
     *     
     */
    public void setZuZeile(ObjectRefType value) {
        this.zuZeile = value;
    }
