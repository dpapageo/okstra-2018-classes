...
/**
 * <p>Java class for BaumreiheType complex type.
 * 
 ...
 *         &lt;element name="besteht_aus_Abschnitt" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "BaumreiheType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "besteht_aus_Abschnitt", required = true)
    protected List<ObjectRefType> bestehtAusAbschnitt;
    ...
    /**
     * Gets the value of the bestehtAusAbschnitt property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the bestehtAusAbschnitt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBestehtAusAbschnitt().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getBestehtAusAbschnitt() {
        if (bestehtAusAbschnitt == null) {
            bestehtAusAbschnitt = new ArrayList<ObjectRefType>();
        }
        return this.bestehtAusAbschnitt;
    }
