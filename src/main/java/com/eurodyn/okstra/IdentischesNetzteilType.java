...
/**
 * <p>Java class for identisches_NetzteilType complex type.
 * 
 ...
 *         &lt;element name="mit_Veraenderungsart" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" minOccurs="0"/&gt;
 *         &lt;element name="Teil_von_Ereignis" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" minOccurs="0"/&gt;
 *         &lt;element name="war_Teilkante" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="wurde_zu_Teilkante" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "identisches_NetzteilType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class IdentischesNetzteilType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "mit_Veraenderungsart")
    protected KeyValuePropertyType mitVeraenderungsart;
    @XmlElement(name = "Teil_von_Ereignis")
    protected ObjectRefType teilVonEreignis;
    @XmlElement(name = "war_Teilkante")
    protected List<ObjectRefType> warTeilkante;
    @XmlElement(name = "wurde_zu_Teilkante")
    protected List<ObjectRefType> wurdeZuTeilkante;
    ...
    /**
     * Gets the value of the mitVeraenderungsart property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public KeyValuePropertyType getMitVeraenderungsart() {
        return mitVeraenderungsart;
    }

    /**
     * Sets the value of the mitVeraenderungsart property.
     * 
     * @param value
     *     allowed object is
     *     {@link KeyValuePropertyType }
     *     
     */
    public void setMitVeraenderungsart(KeyValuePropertyType value) {
        this.mitVeraenderungsart = value;
    }

    /**
     * Gets the value of the teilVonEreignis property.
     * 
     * @return
     *     possible object is
     *     {@link ObjectRefType }
     *     
     */
    public ObjectRefType getTeilVonEreignis() {
        return teilVonEreignis;
    }

    /**
     * Sets the value of the teilVonEreignis property.
     * 
     * @param value
     *     allowed object is
     *     {@link ObjectRefType }
     *     
     */
    public void setTeilVonEreignis(ObjectRefType value) {
        this.teilVonEreignis = value;
    }

    /**
     * Gets the value of the warTeilkante property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the warTeilkante property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWarTeilkante().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getWarTeilkante() {
        if (warTeilkante == null) {
            warTeilkante = new ArrayList<ObjectRefType>();
        }
        return this.warTeilkante;
    }

    /**
     * Gets the value of the wurdeZuTeilkante property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the wurdeZuTeilkante property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWurdeZuTeilkante().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getWurdeZuTeilkante() {
        if (wurdeZuTeilkante == null) {
            wurdeZuTeilkante = new ArrayList<ObjectRefType>();
        }
        return this.wurdeZuTeilkante;
    }
