...
/**
 * <p>Java class for Berechnung_REB_22013Type complex type.
 * 
 ...
 *         &lt;element name="Bezeichnung_Berechnung" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *         &lt;element name="Bezeichnung_Massnahme" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="Auftragsnummer" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 ...
 *         &lt;element name="Zeitstempel" type="{http://www.okstra.de/okstra/2.018.2}ZeitpunktPropertyType" minOccurs="0"/&gt;
 *         &lt;element name="Aufsteller" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="Erlaeuterung" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="hat_Mengendefinition" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Berechnung_REB_22013Type", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class BerechnungREB22013Type
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Bezeichnung_Berechnung", required = true)
    protected String bezeichnungBerechnung;
    @XmlElement(name = "Bezeichnung_Massnahme")
    protected String bezeichnungMassnahme;
    ...
    @XmlElement(name = "Zeitstempel")
    protected ZeitpunktPropertyType zeitstempel;
    @XmlElement(name = "Aufsteller")
    protected String aufsteller;
    @XmlElement(name = "Erlaeuterung")
    protected String erlaeuterung;
    @XmlElement(name = "hat_Mengendefinition", required = true)
    protected List<ObjectRefType> hatMengendefinition;
    ...
    /**
     * Gets the value of the bezeichnungBerechnung property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getBezeichnungBerechnung() {
        return bezeichnungBerechnung;
    }

    /**
     * Sets the value of the bezeichnungBerechnung property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setBezeichnungBerechnung(String value) {
        this.bezeichnungBerechnung = value;
    }

    /**
     * Gets the value of the bezeichnungMassnahme property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getBezeichnungMassnahme() {
        return bezeichnungMassnahme;
    }

    /**
     * Sets the value of the bezeichnungMassnahme property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setBezeichnungMassnahme(String value) {
        this.bezeichnungMassnahme = value;
    }

    /**
     * Gets the value of the auftragsnummer property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the auftragsnummer property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     ...
     *     
     */
    public ZeitpunktPropertyType getZeitstempel() {
        return zeitstempel;
    }
     ...
     *     
     */
    public void setZeitstempel(ZeitpunktPropertyType value) {
        this.zeitstempel = value;
    }

    /**
     * Gets the value of the aufsteller property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getAufsteller() {
        return aufsteller;
    }

    /**
     * Sets the value of the aufsteller property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAufsteller(String value) {
        this.aufsteller = value;
    }
    ...
    /**
     * Gets the value of the hatMengendefinition property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatMengendefinition property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatMengendefinition().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatMengendefinition() {
        if (hatMengendefinition == null) {
            hatMengendefinition = new ArrayList<ObjectRefType>();
        }
        return this.hatMengendefinition;
    }
