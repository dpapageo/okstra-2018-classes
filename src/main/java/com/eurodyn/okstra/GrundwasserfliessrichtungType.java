...
/**
 * <p>Java class for GrundwasserfliessrichtungType complex type.
 * 
 ...
 *         &lt;element name="Richtungswinkel" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Gon"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "GrundwasserfliessrichtungType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class GrundwasserfliessrichtungType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Richtungswinkel", required = true)
    protected Gon richtungswinkel;
    ...
    /**
     * Gets the value of the richtungswinkel property.
     * 
     * @return
     *     possible object is
     *     {@link Gon }
     *     
     */
    public Gon getRichtungswinkel() {
        return richtungswinkel;
    }

    /**
     * Sets the value of the richtungswinkel property.
     * 
     * @param value
     *     allowed object is
     *     {@link Gon }
     *     
     */
    public void setRichtungswinkel(Gon value) {
        this.richtungswinkel = value;
    }
