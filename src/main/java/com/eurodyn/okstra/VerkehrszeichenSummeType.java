...
/**
 * <p>Java class for Verkehrszeichen_SummeType complex type.
 * 
 ...
 *         &lt;element name="Schilder" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Anzahl"/&gt;
 *         &lt;element name="Aufstellvorrichtungen" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Anzahl"/&gt;
 ...
 *         &lt;element name="saisonale_Schilder" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Anzahl" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Verkehrszeichen_SummeType", propOrder = {
    "rest"
})
public class VerkehrszeichenSummeType
    extends AbstractFeatureType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "saisonale_Schilder", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Schilder", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Aufstellvorrichtungen", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
     ...
     * line 218 of file:/C:/repo/SIB-BW2-deliverypatch/SIB-BW2/okstra-2018-classes/src/main/resources/lib/oklabi/schema/2018.2/S_Statische_Beschilderung.xsd
