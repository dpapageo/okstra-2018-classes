...
@XmlType(name = "ParameterValueType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
    "value",
    "dmsAngleValue",
    "stringValue",
    "integerValue",
    ...
    extends AbstractGeneralParameterValueType
{
    ...
    @XmlElementRef(name = "operationParameter", namespace = "http://www.opengis.net/gml/3.2", type = CoordinateOperationParameter.class)
     ...
     * @return
     *     possible object is
     *     {@link CoordinateOperationParameter }
