...
/**
 * <p>Java class for BiotopentwicklungType complex type.
 * 
 ...
 *         &lt;element name="hat_Zielbiotop" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="hat_Ausgangsbiotop" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "BiotopentwicklungType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class BiotopentwicklungType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "hat_Zielbiotop", required = true)
    protected List<ObjectRefType> hatZielbiotop;
    @XmlElement(name = "hat_Ausgangsbiotop", required = true)
    protected List<ObjectRefType> hatAusgangsbiotop;
    ...
    /**
     * Gets the value of the hatZielbiotop property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatZielbiotop property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatZielbiotop().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatZielbiotop() {
        if (hatZielbiotop == null) {
            hatZielbiotop = new ArrayList<ObjectRefType>();
        }
        return this.hatZielbiotop;
    }

    /**
     * Gets the value of the hatAusgangsbiotop property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatAusgangsbiotop property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatAusgangsbiotop().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatAusgangsbiotop() {
        if (hatAusgangsbiotop == null) {
            hatAusgangsbiotop = new ArrayList<ObjectRefType>();
        }
        return this.hatAusgangsbiotop;
    }
