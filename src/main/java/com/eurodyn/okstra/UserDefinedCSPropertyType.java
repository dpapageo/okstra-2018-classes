...
@XmlType(name = "UserDefinedCSPropertyType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
    "userDefinedCS"
})
public class UserDefinedCSPropertyType {

    @XmlElementRef(name = "UserDefinedCS", namespace = "http://www.opengis.net/gml/3.2", type = CoordinateSystemsUserDefinedCS.class, required = false)
    protected CoordinateSystemsUserDefinedCS userDefinedCS;
     ...
     *     
     */
    public CoordinateSystemsUserDefinedCS getUserDefinedCS() {
     ...
     *     
     */
    public void setUserDefinedCS(CoordinateSystemsUserDefinedCS value) {
