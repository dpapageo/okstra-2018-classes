...
/**
 * <p>Java class for BlattType complex type.
 * 
 ...
 *         &lt;element name="enthaelt_Zeile" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "BlattType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "zu_Berechnung", required = true)
    protected ObjectRefType zuBerechnung;
    @XmlElement(name = "definiert_Konstante")
    protected List<ObjectRefType> definiertKonstante;
    @XmlElement(name = "enthaelt_Zeile")
    protected List<ObjectRefType> enthaeltZeile;
    ...
    /**
     * Gets the value of the zuBerechnung property.
     * 
     * @return
     *     possible object is
     *     {@link ObjectRefType }
     *     
     */
    public ObjectRefType getZuBerechnung() {
        return zuBerechnung;
    }

    /**
     * Sets the value of the zuBerechnung property.
     * 
     * @param value
     *     allowed object is
     *     {@link ObjectRefType }
     *     
     */
    public void setZuBerechnung(ObjectRefType value) {
        this.zuBerechnung = value;
    }
    ...
    /**
     * Gets the value of the enthaeltZeile property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the enthaeltZeile property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEnthaeltZeile().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getEnthaeltZeile() {
        if (enthaeltZeile == null) {
            enthaeltZeile = new ArrayList<ObjectRefType>();
        }
        return this.enthaeltZeile;
    }
