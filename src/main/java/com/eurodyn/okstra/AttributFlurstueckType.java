...
/**
 * <p>Java class for Attribut_FlurstueckType complex type.
 * 
 ...
 *         &lt;element name="Attributname" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *         &lt;element name="Attributdatum" type="{http://www.w3.org/2001/XMLSchema}date" minOccurs="0"/&gt;
 *         &lt;element name="Attributstatus" type="{http://www.w3.org/2001/XMLSchema}boolean"/&gt;
 *         &lt;element name="Attributtext" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlType(name = "Attribut_FlurstueckType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class AttributFlurstueckType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Attributname", required = true)
    protected String attributname;
    @XmlElement(name = "Attributdatum")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar attributdatum;
    @XmlElement(name = "Attributstatus")
    protected boolean attributstatus;
    @XmlElement(name = "Attributtext")
    protected String attributtext;
    ...
    /**
     * Gets the value of the attributdatum property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public XMLGregorianCalendar getAttributdatum() {
        return attributdatum;
    }

    /**
     * Sets the value of the attributdatum property.
     * 
     * @param value
     *     allowed object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public void setAttributdatum(XMLGregorianCalendar value) {
        this.attributdatum = value;
    }

    /**
     * Gets the value of the attributstatus property.
     * 
     */
    public boolean isAttributstatus() {
        return attributstatus;
    }

    /**
     * Sets the value of the attributstatus property.
     * 
     */
    public void setAttributstatus(boolean value) {
        this.attributstatus = value;
    }

    /**
     * Gets the value of the attributtext property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the attributtext property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAttributtext(String value) {
        this.attributtext = value;
    }
