...
@XmlType(name = "LinearCSPropertyType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
    "linearCS"
})
public class LinearCSPropertyType {

    @XmlElementRef(name = "LinearCS", namespace = "http://www.opengis.net/gml/3.2", type = CoordinateSystemsLinearCS.class, required = false)
    protected CoordinateSystemsLinearCS linearCS;
     ...
     *     
     */
    public CoordinateSystemsLinearCS getLinearCS() {
        return linearCS;
    }
     ...
     *     
     */
    public void setLinearCS(CoordinateSystemsLinearCS value) {
        this.linearCS = value;
    }
