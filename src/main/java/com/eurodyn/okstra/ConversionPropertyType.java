...
@XmlType(name = "ConversionPropertyType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
    "conversion"
})
public class ConversionPropertyType {

    @XmlElementRef(name = "Conversion", namespace = "http://www.opengis.net/gml/3.2", type = CoordinateOperationConversion.class, required = false)
    protected CoordinateOperationConversion conversion;
     ...
     *     
     */
    public CoordinateOperationConversion getConversion() {
        return conversion;
    }
     ...
     *     
     */
    public void setConversion(CoordinateOperationConversion value) {
