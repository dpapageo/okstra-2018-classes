...
/**
 * <p>Java class for KoordinatenkonstanteType complex type.
 * 
 ...
 *         &lt;element name="Versionsinfo" type="{http://www.okstra.de/okstra/2.018.2}VersionsinfoPropertyType" minOccurs="0"/&gt;
 *         &lt;element name="zu_Berechnung" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" minOccurs="0"/&gt;
 *         &lt;element name="zu_Blatt" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" minOccurs="0"/&gt;
...
@XmlType(name = "KoordinatenkonstanteType", propOrder = {
    "rest"
})
public class KoordinatenkonstanteType
    extends AbstractFeatureType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "x_Koordinate", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "y_Koordinate", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "z_Koordinate", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "zu_Blatt", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
     ...
     * line 71 of file:/C:/repo/SIB-BW2-deliverypatch/SIB-BW2/okstra-2018-classes/src/main/resources/lib/oklabi/schema/2018.2/S_Allgemeine_Mengenberechnung.xsd
