...
/**
 * <p>Java class for Anordnung_des_MesssystemsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Anordnung_des_MesssystemsType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="hat_Art_der_Anordnung" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "Anordnung_des_MesssystemsType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class AnordnungDesMesssystemsType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "hat_Art_der_Anordnung", required = true)
    protected List<ObjectRefType> hatArtDerAnordnung;
    ...
    /**
     * Gets the value of the hatArtDerAnordnung property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatArtDerAnordnung property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatArtDerAnordnung().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatArtDerAnordnung() {
        if (hatArtDerAnordnung == null) {
            hatArtDerAnordnung = new ArrayList<ObjectRefType>();
        }
        return this.hatArtDerAnordnung;
    }
