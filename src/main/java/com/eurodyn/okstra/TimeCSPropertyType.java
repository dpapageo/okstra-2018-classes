...
@XmlType(name = "TimeCSPropertyType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
    "timeCS"
})
public class TimeCSPropertyType {

    @XmlElementRef(name = "TimeCS", namespace = "http://www.opengis.net/gml/3.2", type = CoordinateSystemsTimeCS.class, required = false)
    protected CoordinateSystemsTimeCS timeCS;
     ...
     *     
     */
    public CoordinateSystemsTimeCS getTimeCS() {
        return timeCS;
    }
     ...
     *     
     */
    public void setTimeCS(CoordinateSystemsTimeCS value) {
        this.timeCS = value;
    }
