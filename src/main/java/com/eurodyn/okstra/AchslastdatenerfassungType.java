...
/**
 * <p>Java class for AchslastdatenerfassungType complex type.
 * 
 ...
 *         &lt;element name="hat_GG_Verteilung_e_FZ_Klasse" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="hat_abgel_Werte_und_Vertlgen" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="hat_Achslastvertlg_e_Achstyps" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AchslastdatenerfassungType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    "referenziertFremddatenbestand",
    "referenziertFremdobjekt",
    "zuKommunikationsobjekt",
    "hatGGVerteilungEFZKlasse",
    "hatAbgelWerteUndVertlgen",
    "hatAchslastvertlgEAchstyps"
})
public class AchslastdatenerfassungType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "hat_GG_Verteilung_e_FZ_Klasse", required = true)
    protected List<ObjectRefType> hatGGVerteilungEFZKlasse;
    @XmlElement(name = "hat_abgel_Werte_und_Vertlgen")
    protected List<ObjectRefType> hatAbgelWerteUndVertlgen;
    @XmlElement(name = "hat_Achslastvertlg_e_Achstyps", required = true)
    protected List<ObjectRefType> hatAchslastvertlgEAchstyps;
    ...
    /**
     * Gets the value of the hatGGVerteilungEFZKlasse property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatGGVerteilungEFZKlasse property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatGGVerteilungEFZKlasse().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatGGVerteilungEFZKlasse() {
        if (hatGGVerteilungEFZKlasse == null) {
            hatGGVerteilungEFZKlasse = new ArrayList<ObjectRefType>();
        }
        return this.hatGGVerteilungEFZKlasse;
    }

    /**
     * Gets the value of the hatAbgelWerteUndVertlgen property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatAbgelWerteUndVertlgen property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatAbgelWerteUndVertlgen().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatAbgelWerteUndVertlgen() {
        if (hatAbgelWerteUndVertlgen == null) {
            hatAbgelWerteUndVertlgen = new ArrayList<ObjectRefType>();
        }
        return this.hatAbgelWerteUndVertlgen;
    }

    /**
     * Gets the value of the hatAchslastvertlgEAchstyps property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatAchslastvertlgEAchstyps property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatAchslastvertlgEAchstyps().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatAchslastvertlgEAchstyps() {
        if (hatAchslastvertlgEAchstyps == null) {
            hatAchslastvertlgEAchstyps = new ArrayList<ObjectRefType>();
        }
        return this.hatAchslastvertlgEAchstyps;
    }
