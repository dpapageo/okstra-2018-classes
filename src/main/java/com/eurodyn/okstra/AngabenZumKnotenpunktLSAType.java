...
/**
 * <p>Java class for Angaben_zum_Knotenpunkt_LSAType complex type.
 * 
 ...
 *         &lt;element name="Zahl_der_Knotenarme" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}Anzahl" minOccurs="0"/&gt;
 *         &lt;element name="Hauptrichtung" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *         &lt;element name="Markierungspfeile" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "Angaben_zum_Knotenpunkt_LSAType", propOrder = {
    "rest"
})
public class AngabenZumKnotenpunktLSAType
    extends AbstractFeatureType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "Zahl_der_Knotenarme", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Markierungspfeile", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Hauptrichtung", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Name", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "von_Lichtsignalanlage", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
     ...
     * line 88 of file:/C:/repo/SIB-BW2-deliverypatch/SIB-BW2/okstra-2018-classes/src/main/resources/lib/oklabi/schema/2018.2/S_Lichtsignalanlage.xsd
