...
public class VerticalCSPropertyType {
    ...
    @XmlElementRef(name = "VerticalCS", namespace = "http://www.opengis.net/gml/3.2", type = CoordinateSystemsVerticalCS.class, required = false)
    protected CoordinateSystemsVerticalCS verticalCS;
     ...
     *     
     */
    public CoordinateSystemsVerticalCS getVerticalCS() {
        return verticalCS;
    }
     ...
     *     
     */
    public void setVerticalCS(CoordinateSystemsVerticalCS value) {
