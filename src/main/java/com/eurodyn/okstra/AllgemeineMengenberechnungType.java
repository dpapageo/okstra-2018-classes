...
/**
 * <p>Java class for Allgemeine_MengenberechnungType complex type.
 * 
 ...
 *         &lt;element name="Formelkatalog" type="{http://www.okstra.de/okstra/2.018.2}FormelkatalogPropertyType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Ordnungsrahmen_Summation" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 ...
 *         &lt;element name="verwendet_Ordnungsrahmen" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="enthaelt_Blatt" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Allgemeine_MengenberechnungType", propOrder = {
    "rest"
})
public class AllgemeineMengenberechnungType
    extends AbstractFeatureType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "enthaelt_Blatt", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Formelkatalog", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Ordnungsrahmen_Summation", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "definiert_Konstante", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "verwendet_Ordnungsrahmen", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false)
    })
     ...
     * line 17 of file:/C:/repo/SIB-BW2-deliverypatch/SIB-BW2/okstra-2018-classes/src/main/resources/lib/oklabi/schema/2018.2/S_Allgemeine_Mengenberechnung.xsd
     ...
     * {@link JAXBElement }{@code <}{@link ObjectRefType }{@code >}
     * {@link JAXBElement }{@code <}{@link FormelkatalogPropertyType }{@code >}
     * {@link JAXBElement }{@code <}{@link String }{@code >}
     * {@link JAXBElement }{@code <}{@link ObjectRefType }{@code >}
     * {@link JAXBElement }{@code <}{@link String }{@code >}
     * {@link JAXBElement }{@code <}{@link ObjectRefType }{@code >}
