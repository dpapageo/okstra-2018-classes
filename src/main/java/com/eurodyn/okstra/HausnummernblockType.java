...
/**
 * <p>Java class for HausnummernblockType complex type.
 * 
 ...
 *         &lt;element name="umfasst_Hausnummernbereich" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="hat_HsNrBlockBezugsobjekt" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "HausnummernblockType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    "referenziertFremddatenbestand",
    "referenziertFremdobjekt",
    "zuKommunikationsobjekt",
    "umfasstHausnummernbereich",
    "hatHsNrBlockBezugsobjekt"
})
public class HausnummernblockType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "umfasst_Hausnummernbereich")
    protected List<ObjectRefType> umfasstHausnummernbereich;
    @XmlElement(name = "hat_HsNrBlockBezugsobjekt")
    protected List<ObjectRefType> hatHsNrBlockBezugsobjekt;
    ...
    /**
     * Gets the value of the umfasstHausnummernbereich property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the umfasstHausnummernbereich property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUmfasstHausnummernbereich().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getUmfasstHausnummernbereich() {
        if (umfasstHausnummernbereich == null) {
            umfasstHausnummernbereich = new ArrayList<ObjectRefType>();
        }
        return this.umfasstHausnummernbereich;
    }

    /**
     * Gets the value of the hatHsNrBlockBezugsobjekt property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatHsNrBlockBezugsobjekt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatHsNrBlockBezugsobjekt().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatHsNrBlockBezugsobjekt() {
        if (hatHsNrBlockBezugsobjekt == null) {
            hatHsNrBlockBezugsobjekt = new ArrayList<ObjectRefType>();
        }
        return this.hatHsNrBlockBezugsobjekt;
    }
