...
/**
 * <p>Java class for VerkehrseinschraenkungType complex type.
 * 
 ...
 *         &lt;element name="Querschnitt_Streifenart" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" minOccurs="0"/&gt;
 *         &lt;element name="Art" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType"/&gt;
 *         &lt;element name="StVO_ZNr_Art" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}StVO_Zeichennummer" minOccurs="0"/&gt;
 *         &lt;element name="Verkehrsrichtung" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" minOccurs="0"/&gt;
 *         &lt;element name="Verkehrsteilnehmergruppe" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" minOccurs="0"/&gt;
 *         &lt;element name="StVO_ZNr_Gruppe" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}StVO_Zeichennummer" minOccurs="0"/&gt;
 *         &lt;element name="Umfang_der_Einschraenkung" type="{http://www.okstra.de/okstra/2.018.2}Umfang_VESPropertyType" minOccurs="0"/&gt;
 *         &lt;element name="StVO_ZNr_Einschraenkung" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}StVO_Zeichennummer" minOccurs="0"/&gt;
 *         &lt;element name="Gueltigkeit" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" minOccurs="0"/&gt;
 *         &lt;element name="StVO_ZNr_Gueltigkeit" type="{http://www.okstra.de/okstra/2.018.2/okstra-typen}StVO_Zeichennummer" minOccurs="0"/&gt;
 *         &lt;element name="Wochentag" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" minOccurs="0"/&gt;
 *         &lt;element name="Einschraenkung_gueltig_von" type="{http://www.w3.org/2001/XMLSchema}time" minOccurs="0"/&gt;
 *         &lt;element name="Einschraenkung_gueltig_bis" type="{http://www.w3.org/2001/XMLSchema}time" minOccurs="0"/&gt;
...
@XmlType(name = "VerkehrseinschraenkungType", propOrder = {
    "rest"
})
public class VerkehrseinschraenkungType
    extends AbstractFeatureType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "Verkehrsrichtung", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "StVO_ZNr_Gruppe", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Verkehrsteilnehmergruppe", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Querschnitt_Streifenart", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "gilt_fuer_Fahrstreifen", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "StVO_ZNr_Art", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "zu_Sachverhalt_Strasse_Weg", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Wochentag", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "StVO_ZNr_Einschraenkung", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Einschraenkung_gueltig_von", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Umfang_der_Einschraenkung", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "StVO_ZNr_Gueltigkeit", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Gueltigkeit", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "Einschraenkung_gueltig_bis", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
     ...
     * line 523 of file:/C:/repo/SIB-BW2-deliverypatch/SIB-BW2/okstra-2018-classes/src/main/resources/lib/oklabi/schema/2018.2/S_Verkehr.xsd
     ...
     * {@link JAXBElement }{@code <}{@link UmfangVESPropertyType }{@code >}
     * {@link JAXBElement }{@code <}{@link String }{@code >}
