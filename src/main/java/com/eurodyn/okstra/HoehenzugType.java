...
/**
 * <p>Java class for HoehenzugType complex type.
 * 
 ...
 *         &lt;element name="hat_HZ_Punkt" type="{http://www.okstra.de/okstra/2.018.2}HZ_PunktPropertyType" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "HoehenzugType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "hat_HZ_Punkt", required = true)
    protected List<HZPunktPropertyType> hatHZPunkt;
    ...
    /**
     * Gets the value of the hatHZPunkt property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatHZPunkt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatHZPunkt().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link HZPunktPropertyType }
     * 
     * 
     */
    public List<HZPunktPropertyType> getHatHZPunkt() {
        if (hatHZPunkt == null) {
            hatHZPunkt = new ArrayList<HZPunktPropertyType>();
        }
        return this.hatHZPunkt;
    }
