...
/**
 * <p>Java class for abgeleitete_Werte_VMType complex type.
 * 
 ...
 *         &lt;element name="von_mittlerer_Geschwindigkeit" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "abgeleitete_Werte_VMType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    "referenziertFremddatenbestand",
    "referenziertFremdobjekt",
    "zuKommunikationsobjekt",
    "vonMittlererGeschwindigkeit"
})
public class AbgeleiteteWerteVMType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "von_mittlerer_Geschwindigkeit")
    protected List<ObjectRefType> vonMittlererGeschwindigkeit;
    ...
    /**
     * Gets the value of the vonMittlererGeschwindigkeit property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the vonMittlererGeschwindigkeit property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVonMittlererGeschwindigkeit().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getVonMittlererGeschwindigkeit() {
        if (vonMittlererGeschwindigkeit == null) {
            vonMittlererGeschwindigkeit = new ArrayList<ObjectRefType>();
        }
        return this.vonMittlererGeschwindigkeit;
    }
