...
public class GeodeticDatumPropertyType {
    ...
    @XmlElementRef(name = "GeodeticDatum", namespace = "http://www.opengis.net/gml/3.2", type = DatumsGeodeticDatum.class, required = false)
    protected DatumsGeodeticDatum geodeticDatum;
     ...
     *     
     */
    public DatumsGeodeticDatum getGeodeticDatum() {
     ...
     *     
     */
    public void setGeodeticDatum(DatumsGeodeticDatum value) {
