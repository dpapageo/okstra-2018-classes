...
@XmlType(name = "TransformationType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
    "method",
    "parameterValue"
})
    ...
    extends AbstractGeneralTransformationType
{
    ...
    @XmlElementRef(name = "parameterValue", namespace = "http://www.opengis.net/gml/3.2", type = CoordinateOperationsparameterValue.class, required = false)
     ...
     * {@link JAXBElement }{@code <}{@link AbstractGeneralParameterValuePropertyType }{@code >}
     * {@link CoordinateOperationsparameterValue }
     * 
     * 
     */
