...
/**
 * <p>Java class for MauerType complex type.
 * 
 ...
 *         &lt;element name="Mauerfunktion" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" minOccurs="0"/&gt;
 *         &lt;element name="hat_Mauerabschnitt" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "MauerType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Mauerfunktion")
    protected KeyValuePropertyType mauerfunktion;
    @XmlElement(name = "hat_Mauerabschnitt", required = true)
    protected List<ObjectRefType> hatMauerabschnitt;
    ...
    /**
     * Gets the value of the mauerfunktion property.
     * 
     * @return
     *     possible object is
     *     {@link KeyValuePropertyType }
     *     
     */
    public KeyValuePropertyType getMauerfunktion() {
        return mauerfunktion;
    }

    /**
     * Sets the value of the mauerfunktion property.
     * 
     * @param value
     *     allowed object is
     *     {@link KeyValuePropertyType }
     *     
     */
    public void setMauerfunktion(KeyValuePropertyType value) {
        this.mauerfunktion = value;
    }

    /**
     * Gets the value of the hatMauerabschnitt property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatMauerabschnitt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatMauerabschnitt().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatMauerabschnitt() {
        if (hatMauerabschnitt == null) {
            hatMauerabschnitt = new ArrayList<ObjectRefType>();
        }
        return this.hatMauerabschnitt;
    }
