...
/**
 * <p>Java class for Zusatz_AsphaltmischgutType complex type.
 * 
...
@XmlType(name = "Zusatz_AsphaltmischgutType", propOrder = {
    "produktbezeichnung",
    "art",
    "menge",
    "hersteller"
})
public class ZusatzAsphaltmischgutType {

    @XmlElement(name = "Produktbezeichnung")
