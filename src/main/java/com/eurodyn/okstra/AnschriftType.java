 ...
 *         &lt;element name="von_Gebaeude" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "von_Gebaeude")
    protected List<ObjectRefType> vonGebaeude;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the vonGebaeude property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVonGebaeude().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getVonGebaeude() {
        if (vonGebaeude == null) {
            vonGebaeude = new ArrayList<ObjectRefType>();
        }
        return this.vonGebaeude;
    }
