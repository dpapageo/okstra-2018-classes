...
/**
 * <p>Java class for QuerneigungsbandType complex type.
 * 
 ...
 *         &lt;element name="hat_QN_Punkt" type="{http://www.okstra.de/okstra/2.018.2}QN_PunktPropertyType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="von_Spur" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "QuerneigungsbandType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class QuerneigungsbandType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "hat_QN_Punkt", required = true)
    protected List<QNPunktPropertyType> hatQNPunkt;
    @XmlElement(name = "von_Spur", required = true)
    protected ObjectRefType vonSpur;
    ...
    /**
     * Gets the value of the hatQNPunkt property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatQNPunkt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatQNPunkt().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link QNPunktPropertyType }
     * 
     * 
     */
    public List<QNPunktPropertyType> getHatQNPunkt() {
        if (hatQNPunkt == null) {
            hatQNPunkt = new ArrayList<QNPunktPropertyType>();
        }
        return this.hatQNPunkt;
    }

    /**
     * Gets the value of the vonSpur property.
     * 
     * @return
     *     possible object is
     *     {@link ObjectRefType }
     *     
     */
    public ObjectRefType getVonSpur() {
        return vonSpur;
    }

    /**
     * Sets the value of the vonSpur property.
     * 
     * @param value
     *     allowed object is
     *     {@link ObjectRefType }
     *     
     */
    public void setVonSpur(ObjectRefType value) {
        this.vonSpur = value;
    }
