...
/**
 * <p>Java class for Komplexer_KnotenType complex type.
 * 
 ...
 *         &lt;element name="Art_komplexer_Knoten" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType"/&gt;
 *         &lt;element name="hat_Verbindungspunkt" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="hat_Strassenelement" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="zu_Netzbezugsobjekt_Kompknoten" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Komplexer_KnotenType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    "hatVerbindungspunkt",
    "hatStrassenelement",
    "zuNetzbezugsobjektKompknoten"
})
public class KomplexerKnotenType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Art_komplexer_Knoten", required = true)
    protected KeyValuePropertyType artKomplexerKnoten;
    @XmlElement(name = "hat_Verbindungspunkt", required = true)
    protected List<ObjectRefType> hatVerbindungspunkt;
    @XmlElement(name = "hat_Strassenelement", required = true)
    protected List<ObjectRefType> hatStrassenelement;
    @XmlElement(name = "zu_Netzbezugsobjekt_Kompknoten")
    protected List<ObjectRefType> zuNetzbezugsobjektKompknoten;
    ...
    /**
     * Gets the value of the artKomplexerKnoten property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public KeyValuePropertyType getArtKomplexerKnoten() {
        return artKomplexerKnoten;
    }

    /**
     * Sets the value of the artKomplexerKnoten property.
     * 
     * @param value
     *     allowed object is
     *     {@link KeyValuePropertyType }
     *     
     */
    public void setArtKomplexerKnoten(KeyValuePropertyType value) {
        this.artKomplexerKnoten = value;
    }

    /**
     * Gets the value of the hatVerbindungspunkt property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatVerbindungspunkt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatVerbindungspunkt().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatVerbindungspunkt() {
        if (hatVerbindungspunkt == null) {
            hatVerbindungspunkt = new ArrayList<ObjectRefType>();
        }
        return this.hatVerbindungspunkt;
    }

    /**
     * Gets the value of the hatStrassenelement property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatStrassenelement property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatStrassenelement().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatStrassenelement() {
        if (hatStrassenelement == null) {
            hatStrassenelement = new ArrayList<ObjectRefType>();
        }
        return this.hatStrassenelement;
    }

    /**
     * Gets the value of the zuNetzbezugsobjektKompknoten property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the zuNetzbezugsobjektKompknoten property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getZuNetzbezugsobjektKompknoten().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getZuNetzbezugsobjektKompknoten() {
        if (zuNetzbezugsobjektKompknoten == null) {
            zuNetzbezugsobjektKompknoten = new ArrayList<ObjectRefType>();
        }
        return this.zuNetzbezugsobjektKompknoten;
    }
