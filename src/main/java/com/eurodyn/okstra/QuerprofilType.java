...
/**
 * <p>Java class for QuerprofilType complex type.
 * 
 ...
 *         &lt;element name="hat_Profillinie" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "QuerprofilType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "hat_Profillinie", required = true)
    protected List<ObjectRefType> hatProfillinie;
    ...
    /**
     * Gets the value of the hatProfillinie property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatProfillinie property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatProfillinie().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatProfillinie() {
        if (hatProfillinie == null) {
            hatProfillinie = new ArrayList<ObjectRefType>();
        }
        return this.hatProfillinie;
    }
