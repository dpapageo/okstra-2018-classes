...
/**
 * <p>Java class for NutzungsartflaecheType complex type.
 * 
 ...
 *         &lt;element name="liegt_auf_Flurstueck" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "NutzungsartflaecheType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class NutzungsartflaecheType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "liegt_auf_Flurstueck")
    protected List<ObjectRefType> liegtAufFlurstueck;
    ...
    /**
     * Gets the value of the liegtAufFlurstueck property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the liegtAufFlurstueck property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLiegtAufFlurstueck().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getLiegtAufFlurstueck() {
        if (liegtAufFlurstueck == null) {
            liegtAufFlurstueck = new ArrayList<ObjectRefType>();
        }
        return this.liegtAufFlurstueck;
    }
