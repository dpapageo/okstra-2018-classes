...
/**
 * <p>Java class for PolizeidienststelleType complex type.
 * 
 ...
 *         &lt;element name="Behoerdenkennung" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *         &lt;element name="zu_zust_Polizei_Arbeitsst" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "PolizeidienststelleType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    "behoerdenkennung",
    "zuZustPolizeiArbeitsst",
    "zuUnfallort"
})
public class PolizeidienststelleType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "Behoerdenkennung", required = true)
    protected String behoerdenkennung;
    @XmlElement(name = "zu_zust_Polizei_Arbeitsst")
    protected List<ObjectRefType> zuZustPolizeiArbeitsst;
     ...
     *     
     */
    public String getBehoerdenkennung() {
     ...
     *     
     */
    public void setBehoerdenkennung(String value) {
        this.behoerdenkennung = value;
    }

    /**
     * Gets the value of the zuZustPolizeiArbeitsst property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the zuZustPolizeiArbeitsst property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getZuZustPolizeiArbeitsst().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getZuZustPolizeiArbeitsst() {
        if (zuZustPolizeiArbeitsst == null) {
            zuZustPolizeiArbeitsst = new ArrayList<ObjectRefType>();
        }
        return this.zuZustPolizeiArbeitsst;
    }
