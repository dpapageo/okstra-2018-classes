...
/**
 * <p>Java class for GG_KlasseType complex type.
 * 
 ...
 *         &lt;element name="von_GG_Verteilung_e_FZ_Klasse" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "GG_KlasseType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    ...
    "klassengrenze",
    "klassenwert",
    "vonGGVerteilungEFZKlasse"
})
public class GGKlasseType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "von_GG_Verteilung_e_FZ_Klasse")
    protected List<ObjectRefType> vonGGVerteilungEFZKlasse;
    ...
    /**
     * Gets the value of the vonGGVerteilungEFZKlasse property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the vonGGVerteilungEFZKlasse property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVonGGVerteilungEFZKlasse().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getVonGGVerteilungEFZKlasse() {
        if (vonGGVerteilungEFZKlasse == null) {
            vonGGVerteilungEFZKlasse = new ArrayList<ObjectRefType>();
        }
        return this.vonGGVerteilungEFZKlasse;
    }
