...
/**
 * <p>Java class for Firma_ArbeitsstelleType complex type.
 * 
 ...
 *         &lt;element name="zu_Durchfuehrendem" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="hat_Ansprechpartner" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Firma_ArbeitsstelleType", propOrder = {
    "okstraid",
    "zuBeschriftung",
...
public class FirmaArbeitsstelleType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "zu_Durchfuehrendem")
    protected List<ObjectRefType> zuDurchfuehrendem;
    @XmlElement(name = "hat_Ansprechpartner")
    protected List<ObjectRefType> hatAnsprechpartner;
    ...
    /**
     * Gets the value of the zuDurchfuehrendem property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the zuDurchfuehrendem property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getZuDurchfuehrendem().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getZuDurchfuehrendem() {
        if (zuDurchfuehrendem == null) {
            zuDurchfuehrendem = new ArrayList<ObjectRefType>();
        }
        return this.zuDurchfuehrendem;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatAnsprechpartner property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatAnsprechpartner().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatAnsprechpartner() {
        if (hatAnsprechpartner == null) {
            hatAnsprechpartner = new ArrayList<ObjectRefType>();
        }
        return this.hatAnsprechpartner;
    }
