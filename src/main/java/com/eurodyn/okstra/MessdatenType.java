...
/**
 * <p>Java class for MessdatenType complex type.
 * 
 ...
 *         &lt;element name="hat_Zaehlintervalllaenge" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}KeyValuePropertyType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="hat_Umfang_Umfelddaten" type="{http://www.okstra.de/okstra/2.018.2/okstra-basis}ObjectRefType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "MessdatenType", propOrder = {
    "okstraid",
    "zuBeschriftung",
    "referenziertFremddatenbestand",
    "referenziertFremdobjekt",
    "zuKommunikationsobjekt",
    "hatZaehlintervalllaenge",
    "hatUmfangUmfelddaten",
    "vonUmfeldmessstelle"
})
public class MessdatenType
    extends AbstractFeatureType
{
    ...
    @XmlElement(name = "hat_Zaehlintervalllaenge")
    protected List<KeyValuePropertyType> hatZaehlintervalllaenge;
    @XmlElement(name = "hat_Umfang_Umfelddaten")
    protected List<ObjectRefType> hatUmfangUmfelddaten;
    ...
    /**
     * Gets the value of the hatZaehlintervalllaenge property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatZaehlintervalllaenge property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatZaehlintervalllaenge().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<KeyValuePropertyType> getHatZaehlintervalllaenge() {
        if (hatZaehlintervalllaenge == null) {
            hatZaehlintervalllaenge = new ArrayList<KeyValuePropertyType>();
        }
        return this.hatZaehlintervalllaenge;
    }

    /**
     * Gets the value of the hatUmfangUmfelddaten property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hatUmfangUmfelddaten property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHatUmfangUmfelddaten().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ObjectRefType> getHatUmfangUmfelddaten() {
        if (hatUmfangUmfelddaten == null) {
            hatUmfangUmfelddaten = new ArrayList<ObjectRefType>();
        }
        return this.hatUmfangUmfelddaten;
    }
