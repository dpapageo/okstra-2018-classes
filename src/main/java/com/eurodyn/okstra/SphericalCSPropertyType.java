...
public class SphericalCSPropertyType {
    ...
    @XmlElementRef(name = "SphericalCS", namespace = "http://www.opengis.net/gml/3.2", type = CoordinateSystemsSphericalCS.class, required = false)
    protected CoordinateSystemsSphericalCS sphericalCS;
     ...
     *     
     */
    public CoordinateSystemsSphericalCS getSphericalCS() {
        return sphericalCS;
    }
     ...
     *     
     */
    public void setSphericalCS(CoordinateSystemsSphericalCS value) {
