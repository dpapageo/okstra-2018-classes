...
/**
 * <p>Java class for TeilelementType complex type.
 * 
 ...
 *         &lt;element name="beginnt_bei_Strassenelempkt" type="{http://www.okstra.de/okstra/2.018.2}StrassenelementpunktPropertyType"/&gt;
 *         &lt;element name="endet_bei_Strassenelempkt" type="{http://www.okstra.de/okstra/2.018.2}StrassenelementpunktPropertyType"/&gt;
...
@XmlType(name = "TeilelementType", propOrder = {
    "rest"
})
public class TeilelementType
    extends AbstractFeatureType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "endet_bei_Strassenelempkt", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "beginnt_bei_Strassenelempkt", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "auf_Strassenelement", namespace = "http://www.okstra.de/okstra/2.018.2", type = JAXBElement.class, required = false),
     ...
     * line 1106 of file:/C:/repo/SIB-BW2-deliverypatch/SIB-BW2/okstra-2018-classes/src/main/resources/lib/oklabi/schema/2018.2/S_Strassennetz.xsd
